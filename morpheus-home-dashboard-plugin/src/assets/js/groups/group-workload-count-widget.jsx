  ...
  render() {
    ...
    return(
      <Widget widgetClass="chart-legend-right">
        <WidgetHeader icon="/assets/infrastructure/sites.svg#Layer_1" title="Group Workloads" titleCode="gomorpheus.widget.title.groupWorkloads" link="/infrastructure/groups"/>
