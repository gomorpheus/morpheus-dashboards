  ...
  render() {
    ...
    return(
      <Widget widgetClass="chart-legend-right">
        <WidgetHeader icon="/assets/infrastructure/clouds.svg#Layer_1" title="Cloud Workloads" titleCode="gomorpheus.widget.title.cloudWorkloads" link="/infrastructure/clouds"/>
